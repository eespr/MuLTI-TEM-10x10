...
load('input_data.mat'); %load received voltages 
...
if priors_OK == 1
    ...
    for i = 1:length(timegate) % time samples, this should match the time samples- miss the first sample.
